...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cc=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --as=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi- --sysinclude=/opt/android-ndk-r4/build/platforms/android-8/arch-arm/usr/include --nm=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-ldflags='-Wl,-T,/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/opt/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -L/opt/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib /opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl' --enable-small --enable-pic --enable-shared --disable-dxva2 --disable-avcore --disable-debug --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-swscale --disable-avfilter --disable-everything --disable-network --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=alac --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --enable-decoder=pcm_s16le_planar --enable-decoder=adpcm_ms --enable-decoder=adpcm_g726 --enable-decoder=gsm --enable-decoder=gsm_ms --enable-decoder=tta --enable-decoder=wmapro --enable-decoder=ape --enable-parser=mpegaudio --enable-protocol=file --enable-protocol=pipe --enable-demuxer=mp3 --enable-demuxer=mov --enable-demuxer=asf --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --enable-demuxer=pcm_alaw --enable-demuxer=pcm_mulaw --enable-demuxer=tta --enable-demuxer=wav --enable-demuxer=ape --cpu=armv6 --disable-armvfp --disable-rdft --enable-decoder=wmav1_fixedpoint --enable-decoder=wmav2_fixedpoint --extra-cflags='-DANDROID --sysroot=/opt/android-ndk-r4/build/platforms/android-4/arch-arm/ -mfloat-abi=soft -ffast-math -mno-thumb -mno-thumb-interwork'
prefix=/usr/local
...
SRC_PATH="/mnt/hgfs/_Andro387/oss/audioplayer_ffmpeg/jni"
SRC_PATH_BARE=/mnt/hgfs/_Andro387/oss/audioplayer_ffmpeg/jni
BUILD_ROOT="/mnt/hgfs/_Andro387/oss/audioplayer_ffmpeg/jni"
CC_IDENT=gcc 4.4.0 (GCC)
ARCH=arm
CC=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -DANDROID --sysroot=/opt/android-ndk-r4/build/platforms/android-4/arch-arm/ -mfloat-abi=soft -ffast-math -mno-thumb -mno-thumb-interwork -march=armv6 -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -DANDROID --sysroot=/opt/android-ndk-r4/build/platforms/android-4/arch-arm/ -mfloat-abi=soft -ffast-math -mno-thumb -mno-thumb-interwork -march=armv6 -fPIC
CC_O=-o $@
LDFLAGS= -Wl,-T,/opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/opt/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -L/opt/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib /opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /opt/android-ndk-r4/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
CONFIG_WMAV1_FIXEDPOINT_DECODER=yes
CONFIG_WMAV2_FIXEDPOINT_DECODER=yes
