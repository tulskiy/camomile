...
CFLAGS= -DANDROID --sysroot=/opt/android-ndk-r4/build/platforms/android-4/arch-arm/ -march=armv7-a -mfpu=neon -mfloat-abi=softfp -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -DANDROID --sysroot=/opt/android-ndk-r4/build/platforms/android-4/arch-arm/ -march=armv7-a -mfpu=neon -mfloat-abi=softfp -march=armv7-a -fPIC
CC_O=-o $@
...
libavformat_VERSION=52.78.3
libavformat_VERSION_MAJOR=52
libavutil_VERSION=50.24.0
